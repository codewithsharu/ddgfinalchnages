        ...
        <div className="flex-1 flex flex-col justify-center max-w-[700px]">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col">
              ...
              <select
                name="location"
                className="w-full bg-transparent border-0 border-b-2 border-[#1a1a1a] text-gray-700 focus:outline-none focus:border-[#000000] focus:border-b-2 py-2 text-xl font-light transition-all duration-300 pr-10"
                style={{fontFamily:'Arial, Helvetica, sans-serif'}}
                value={location}
        ...
        <div className="w-full lg:w-[450px] xl:w-[500px] bg-gradient-to-br from-[#2a2a2a] to-[#1a1a1a] p-6 lg:p-8 xl:p-12 flex flex-col justify-between rounded-2xl shadow-2xl border border-[#c5a46d]/20 backdrop-blur-sm min-h-[450px] lg:min-h-[550px] xl:min-h-[580px]">
          <div className="flex-1">
            ...
            <div className="mb-6 lg:mb-8 xl:mb-9">
              ...
              <div className="ml-8 lg:ml-11">
                <div className="mb-6">
                  <p className="text-[#e5e5e5] text-sm lg:text-base xl:text-lg leading-relaxed font-light"
                     style={{fontFamily:'Arial, Helvetica, sans-serif', lineHeight:'1.6', marginBottom: '0.5em'}}>
                    <span style={{fontWeight:'bold', color:'#44b1e4'}}>Hyderabad</span><br />
                    Design & Décor Guide,<br />
                    D.No - 2/97A, Opposite to vignanajyothi college,<br />
                ...
                <div>
                  <p className="text-[#e5e5e5] text-sm lg:text-base xl:text-lg leading-relaxed font-light"
                    ...
                    <span style={{fontWeight:'bold', color:'#44b1e4'}}>Vizag</span><br />
                    D.No. 51-17-37, behind Jayabheri Maruthi Showroom,<br />
                    Kranthi Nagar, Maddilapalem,<br />
          ...
          <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 xl:gap-12 items-start">
            ...
            <div className="w-full lg:w-1/3 pt-2 lg:pt-4">
              ...
              <div className="space-y-2 lg:space-y-3 text-gray-700 text-base lg:text-lg" style={{fontFamily: 'Arial, sans-serif'}}>
                ...
                {/* Hyderabad Address */}
                <p className="font-medium">D.No - 2/97A, Opposite to vignanajyothi college,</p>
                <p>Bachupally, Hyderabad, Telangana 500118</p>
