        ...
        <div className="w-full relative z-10">
          ...
          <div className="lg:flex lg:flex-wrap lg:justify-center lg:items-center lg:gap-6 xl:gap-10 lg:px-8">
            ...
            <div className="lg:hidden relative w-full overflow-hidden">
              <div className="flex animate-scroll-mobile gap-8 py-4" style={{ width: 'calc(200% + 32px)' }}>
                ...
                <div className="flex gap-8 min-w-full justify-start pl-4">
                  ...
                  <div className="text-center flex-shrink-0">
                    <div className="w-36 h-36 border-2 border-sky-500 rounded-full flex flex-col items-center justify-center bg-white">
                      <div className="text-sm font-semibold mb-1 text-sky-500">Happy homes delivered till now</div>
                      <div className="text-xs font-bold text-gray-800">500+</div>
                    </div>
                  </div>
                ...
                <div className="flex gap-8 min-w-full justify-start pl-4">
                  ...
                  <div className="text-center flex-shrink-0">
                    <div className="w-36 h-36 border-2 border-sky-500 rounded-full flex flex-col items-center justify-center bg-white">
                      <div className="text-sm font-semibold mb-1 text-sky-500">experienced team</div>
                      <div className="text-xs font-bold text-gray-800">for support</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="hidden lg:contents">
              ...
              <div className="text-center">
                <div className="w-44 h-44 border-2 border-sky-500 rounded-full flex flex-col items-center justify-center bg-white">
                  <div className="text-lg font-semibold mb-2 text-sky-500">Happy homes delivered till now</div>
                  <div className="text-2xl font-bold text-gray-800">500+</div>
                </div>
              </div>
              ...
              <div className="text-center">
                <div className="w-44 h-44 border-2 border-sky-500 rounded-full flex flex-col items-center justify-center bg-white">
                  <div className="text-lg font-semibold mb-2 text-sky-500">experienced team</div>
                  <div className="text-lg font-bold text-gray-800">for support</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-5 order-1 lg:order-2">
              ...
              <div className="space-y-6 text-gray-600 leading-relaxed text-lg">
                <p>
                  Meet Chinna Babu K, the visionary mind behind DESIGN & DECOR GUIDE. With over a decade of experience in interior design, he has transformed countless spaces into beautiful, functional, and inspiring environments for people to live and work.
                </p>
                
                
                
                <p>
                  During his early years as a designer, he noticed inefficiencies in project execution—long timelines, unnecessary material wastage, and gaps in communication. Determined to make a difference, he turned these challenges into opportunities. His mission became clear: to streamline processes, minimize waste, and deliver exceptional results with precision and speed.
                </p>
                <p className="font-semibold text-gray-800 text-xl">
                  In 2017, Chinna Babu K founded DESIGN & DECOR GUIDE with a single goal — to help people fall in love with their spaces. Today, he leads a talented team of designers and craftsmen who create customized solutions that combine style, comfort, and innovation, ensuring every project reflects the unique personality of its owner.
                </p>
              </div>
